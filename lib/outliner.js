...
function outline(outFile, generatedFile, mapFile, sourceMap) {
    ...
    function writeMapName(writer) {
        writer.writeln("<div class='map-name'>${mapFile}</div>", { mapFile: mapFile });
    }
...
//# sourceMappingURL=F:/Workspaces/SourceMaps/lib/outliner.js.map